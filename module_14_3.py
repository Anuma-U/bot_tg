...
async def get_buying_list(message):
    for numb in range(1, 5):
        txt_for_answer = f"Название: Product{numb} | Описание: описание {numb} | Цена: {numb * 100}"
        with open(f"picture{numb}.jpg", "rb") as img:
            await message.answer_photo(img, txt_for_answer)
